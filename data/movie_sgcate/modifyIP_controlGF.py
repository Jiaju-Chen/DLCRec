...
GF_paths = [
    # "./movie_sgcate_result/BERT_GF_vlGF_ep25_1e-3_controlGP_1_-1_1e-3_0.05_2GF1000gred.json",
    # "./movie_sgcate_result/BERT_GF_vlGF_ep25_1e-3_controlGP_1_-1_1e-3_0.05_5GF1000gred.json",
    # "./movie_sgcate_result/BERT_GF_vlGF_ep25_1e-3_controlGP_1_-1_1e-3_0.05_8GF1000gred.json",

]

IP_test_data_path = './data//movie_sgcate/test_1000_BERT_IP.json'
IP_test_data_path_controlGF = './data//movie_sgcate/test_1000_BERT_IP_controlGF.json'
